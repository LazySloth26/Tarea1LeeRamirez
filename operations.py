...
def error_handling(x, y, operation): #Esta funcion maneja los errores que se puedan producir en el array_ops
    ...
    if len(x) != len(y): #Revisa que sean del mismo tamaño
        ...
        for i in x: #Revisa cada instancia de la lista
            ...
            #if not isinstance(y, int):  # Pregunta si NO es un integer/entero
...
class operations:
    ...
    def array_ops(self, x, y, operation): #recibe dos arreglos y realiza operaciones con dichos arreglos
        ...
        error_handling(x, y, operation) #llama la funcion que maneja los errores a verificar en array_ops
